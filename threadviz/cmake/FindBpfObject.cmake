...
macro(bpf_object name input)
  ...
  # Add dummy target for compile_commands.json
  add_library(${name}_dummy OBJECT ${BPF_C_FILE})
  set_target_properties(${name}_dummy PROPERTIES
    COMPILE_OPTIONS "-g;-O2;-target;bpf;-D__TARGET_ARCH_${ARCH};${CLANG_SYSTEM_INCLUDES};-I${GENERATED_VMLINUX_DIR};-isystem;${LIBBPF_INCLUDE_DIRS}"
    OUTPUT_NAME ${name}.bpf.o
